...
import { ChatGPTPromptDialog2 } from '@teos_ai_helper/ai_helper/chatgpt_prompt_dialog';
import { _t } from "@web/core/l10n/translation";



export class SwitchCompanyMenu extends Component {
    static template = "teos_ai_helper.SwitchCompanyMenu";
    static props = {};
...
registry.category("systray").add("SwitchCompanyMenu2", systrayItem, { sequence: 1 });
